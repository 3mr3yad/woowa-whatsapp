<x-app-layout>
    <div class="py-10">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <h1 class="text-2xl font-semibold tracking-tight text-gray-900 dark:text-gray-100">Edit Campaign</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Update the campaign message or replace the image.</p>
            </div>
            ...
            <form x-data="{
                ...
                <div>
                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-100">Replace Image (optional)</label>
                ...
                <div class="flex items-center justify-end gap-3">
                    ...
                    <button type="submit"
                        ...
                        <span x-show="!uploading">Save Changes</span>
                        <span x-show="uploading" style="display: none;">Saving...</span>
                    </button>
                </div>
            </form>
        </div>
